...
<body>
<?php # Script 10.2 - add_category.php
// This page allows the administrator to add a category.
...
if (isset($_POST['submitted']))		// Handle the form.
{
	...
	if (empty($errors))		// If everything's OK.
	{
		...
		if (mysqli_stmt_affected_rows($stmt) == 1) {
			...
			// Print a message:
			echo '<p>Η κατηγορία προστέθηκε.</p>';
...
<form enctype="multipart/form-data" action="add_category.php" method="post">
	...
	<fieldset><legend>Συμπληρώστε τη φόρμα προσθήκης κατηγορίας:</legend>
	
	<table border="0" width="50%" cellspacing="5" cellpadding="15" align="center">
		<tr>
			<td align="left"><b>Όνομα κατηγορίας:</b></td>
			<td align="left"><input type="text" name="category_name" size="50" maxlength="60" value="<?php if (isset($_POST['category_name'])) echo htmlspecialchars($_POST['category_name']); ?>" /></td>
		</tr>	
	</table>
